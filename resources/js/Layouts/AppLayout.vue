            ...
            <div class="main-sidebar">
                <div
                    ...
                    <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                        <!-- Dashobards -->
                        <a @click="setMenu('home')" x-tooltip.placement.right="'Dashboard'" :class="[activeMenu === 'home' ? 'bg-primary/10 text-primary' : '']"
                        ...
                        <!-- Apps -->
                        <a @click="setMenu('sample')"  x-tooltip.placement.right="'Applications'" :class="[activeMenu === 'sample' ? 'bg-primary/10 text-primary' : '']" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <div class="flex flex-col items-center space-y-3 py-3">
                        ...
                        <!-- Profile -->
                        <div class="flex">
                            <button @click="toggleProfileBar = !toggleProfileBar" class="avatar size-12">
                                <img class="rounded-full" :src="$page.props.auth.user.profile_photo_url" alt="avatar">
                                <span
                                    class="absolute right-0 size-3.5 rounded-full border-2 border-white bg-success dark:border-navy-700"></span>
                            </button>

                            <div class="popper-root fixed" :class="[toggleProfileBar ? 'show':'']"
                                 style="position: fixed; inset: auto auto 0px 0px; margin: 0px; transform: translate(76px, -10px);"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="avatar size-14">
                                            <img class="rounded-full" :src="$page.props.auth.user.profile_photo_url"
                                                 alt="avatar">
                                        </div>
                                        <div>
                                            <a href="#"
                ...
                <div class="flex w-full items-center justify-between">
                    ...
                    <div class="-mr-1.5 flex items-center space-x-2">
                        ...
                        <button @click="toggleDarkMode"
                            ...
                            <svg v-if="isDarkMode" class="size-6 text-amber-400" fill="currentColor"
                                 viewBox="0 0 24 24">
                                <path
                            ...
                            <svg v-else xmlns="http://www.w3.org/2000/svg" x-show="!$store.global.isDarkModeEnabled"
                        ...
                        <!-- Dark Mode Toggle -->
                        <button @click="toggleMonochromeMode"
                                class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <i class="fa-solid fa-palette bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-lg font-semibold"></i>
                        </button>
...
export default {
    ...
    setup() {
        ...
        const isSidebarExpanded = ref(localStorage.getItem('sidebar-expanded') === 'true');
