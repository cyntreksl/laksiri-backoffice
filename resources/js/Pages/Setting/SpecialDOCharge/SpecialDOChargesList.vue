          ...
          <DataTable
            ...
            <template #header>
              <div class="flex flex-col sm:flex-row justify-between items-center mb-2">
                ...
                <div>
                  <Link v-if="usePage().props.user.permissions.includes('charges.special do charges create')" :href="route('setting.special-do-charges.create')">
                    <PrimaryButton> Create DO Charge</PrimaryButton>
                  </Link>
                </div>
              </div>
