...
const createColumns = () => [
  ...
  { name: "Description", hidden: !data.columnVisibility.description },
  {
    name: "Branch Name",
      ...
      return h("div", {}, [
        ...
        h(
          "button",
          {
            ...
            onClick: () => confirmWarehouseZone(row.cells[0].data),
          },
          [
            h(
              "svg",
...
const showConfirmWarehouseZoneModal = ref(false);
const warehousezoneid = ref(null);

const confirmWarehouseZone = (id) => {
  warehousezoneid.value = id;
  showConfirmWarehouseZoneModal.value = true;
};

const closeModal = () => {
  showConfirmWarehouseZoneModal.value = false;
};

const handleDeleteWarehousezone = () => {
  router.delete(
    route("setting.warehouse-zones.delete", warehousezoneid.value),
    {
      preserveScroll: true,
      preserveState: true,
      onSuccess: () => {
...
<template>
  <AppLayout title="Warehouse Zones">
    ...
    <CreateWarehousezoneForm :branches="branches" />
