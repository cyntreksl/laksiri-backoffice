...
<template>
    <AppLayout title="Create Price Rule">
        <template #header>Edit Package Price Rule</template>
        ...
        <form @submit.prevent="handlePackagePriceRuleUpdate">
            <div class="flex items-center justify-end p-2 my-5 space-x-2">
                ...
                <Button :class="{ 'opacity-50': form.processing }" :disabled="form.processing" icon="pi pi-arrow-right" iconPos="right" label="Save Package Rule" type="submit" />
            </div>

            <div class="grid grid-cols-1 mt-4 gap-4">
                <div class="sm:col-span-3 space-y-5">
                    <Card>
                        <template #title>Edit Package Price Rule</template>
                        <template #content>
