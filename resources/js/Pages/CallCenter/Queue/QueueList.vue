                ...
                handle: '.board-draggable-handler'
                    ...
                    <div class="relative flex max-h-full w-1/3 shrink-0 flex-col">
                        ...
                        <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5"
                            ...
                            <div v-for="queue in documentVerificationQueue" class="card grow cursor-pointer hover:bg-purple-100 items-center p-4 text-center sm:p-5">
                                <div class="my-5">
                    ...
                    <div class="relative flex max-h-full w-1/3 shrink-0 flex-col">
                        ...
                        <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5"
                            ...
                            <div v-for="queue in cashierQueue" class="card grow cursor-pointer hover:bg-purple-100 items-center p-4 text-center sm:p-5">
                                <div class="my-5">
                                    <h1 class="text-8xl text-black font-bold">{{queue.token}}</h1>
                                </div>
                                <div class="my-2 grow">
                    ...
                    <div class="relative flex max-h-full w-1/3 shrink-0 flex-col">
                        <div class="board-draggable-handler flex items-center justify-between px-0.5 pb-3">
                            <div class="flex items-center space-x-4">
                                <div
                                    ...
                                    <svg  class="icon icon-tabler icons-tabler-outline icon-tabler-binoculars size-8"  fill="none"  height="24"  stroke="currentColor"  stroke-linecap="round"  stroke-linejoin="round"  stroke-width="2"  viewBox="0 0 24 24"  width="24"  xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none" stroke="none"/><path d="M7 16m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M17 16m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M16.346 9.17l-.729 -1.261c-.16 -.248 -1.056 -.203 -1.117 .091l-.177 1.38" /><path d="M19.761 14.813l-2.84 -5.133c-.189 -.31 -.592 -.68 -1.421 -.68c-.828 0 -1.5 .448 -1.5 1v6" /><path d="M7.654 9.17l.729 -1.261c.16 -.249 1.056 -.203 1.117 .091l.177 1.38" /><path d="M4.239 14.813l2.84 -5.133c.189 -.31 .592 -.68 1.421 -.68c.828 0 1.5 .448 1.5 1v6" /><rect height="2" width="4" x="10" y="12" /></svg>
                                </div>
                                <h3 class="text-2xl font-bold text-slate-700 dark:text-navy-100">
                                    Examination
                                </h3>
                        ...
                        <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5"
                            ...
                            <div v-for="queue in examinationQueue" class="card grow cursor-pointer hover:bg-purple-100 items-center p-4 text-center sm:p-5">
                                <div class="my-5">
                                    <h1 class="text-8xl text-black font-bold">{{queue.token}}</h1>
                                </div>
                                <div class="my-2 grow">
