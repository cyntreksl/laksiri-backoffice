...
<!--                    ship/flight details-->
                    <div v-if="form.cargo_type==='Sea Cargo'" class="sm:col-span-3 space-y-5">
                        <div class="card px-4 py-4 sm:px-5">
                            <div>
                                <h2 class="text-lg font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100">
                                    Vessel Details
                    ...
                    <div class="flex justify-end space-x-5">
                        <DangerOutlineButton @click="router.visit(route('loading.loading-containers.index'))">Cancel</DangerOutlineButton>
...
export default {
    components: {
        DangerOutlineButton,
        InputError, Checkbox, ColumnVisibilityPopover, PrimaryButton, Link, Breadcrumb, AppLayout},
    props: {
        cargoTypes: {
            type: Array,
            required: true
