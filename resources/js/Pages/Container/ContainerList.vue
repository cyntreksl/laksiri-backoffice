...
const menuModel = ref([
    ...
    },
    {
        ...
        command: () => router.visit(route("loading.loading-points.index", {
            container: selectedContainer.value.id,
                    ...
                    <DataTable
                        ...
                        <template #header>
                            <div class="flex flex-col sm:flex-row justify-between items-center mb-2">
                                ...
                                <div>
                                    <Button
                                        v-if="$page.props.user.permissions.includes('container.create')"
                                        class="w-full"
                                        @click="router.visit(route('loading.loading-containers.create'))"
                                    >
                                        Create New Shipment
                                    </Button>
                                </div>
