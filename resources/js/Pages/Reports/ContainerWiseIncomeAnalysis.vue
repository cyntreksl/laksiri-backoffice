...
const fetchData = async () => {
    ...
    try {
        ...
        const response = await axios.get(route('report.container-wise-income.data'), { params });
        ...
        console.error('Error fetching container wise income analysis:', error);
        push.error('Failed to load container wise income analysis data');
    } finally {
        loading.value = false;
    }
};
...
const onSort = (event) => {
    lazyParams.sort_field = event.sortField || 'destuff_date';
...
const exportData = (format = 'xlsx') => {
    ...
    window.location.href = route('report.container-wise-income.export') + '?' + queryString;
...
<template>
    <AppLayout title="Container Wise Income Analysis">
        <template #header>Container Wise Income Analysis</template>

        <div class="container-wise-income-page">
            <!-- Page Header -->
            <div class="page-header">
                <div class="header-content">
                    <div class="header-left">
                        <i class="ti ti-container text-4xl text-primary"></i>
                        <div>
                            <h1 class="text-3xl font-bold text-gray-800">Container Wise Income Analysis</h1>
                            <p class="text-gray-600 mt-1">Income analysis for {{ reportDate }}</p>
                        </div>
                    </div>
                    ...
                    <template #content>
                        <div class="card-content">
                            ...
                            <div>
                                ...
                                <p class="text-3xl font-bold text-purple-600">{{ stats.total_cons }}</p>
                            </div>
                        </div>
                    </template>
                </Card>
                    ...
                    <template #content>
                        <div class="card-content">
                            ...
                            <div>
                                ...
                                <p class="text-3xl font-bold text-orange-600">{{ stats.total_pkgs }}</p>
                            </div>
                        </div>
                    </template>
                </Card>
                    ...
                    <div class="filters-section">
                        <div class="filters-grid">
                            ...
                            <FloatLabel class="w-full" variant="in">
                                ...
                                />
                                <label for="search">Search (Container/Agent)</label>
                            </FloatLabel>
                        </div>
                    ...
                    >
                        <template #empty>
                            <div class="empty-state">
                                ...
                                <p class="text-gray-500 mt-4">No container records found</p>
                            </div>
                        </template>

                        <template #loading> Loading container data. Please wait.</template>

                        <Column field="container_number" frozen style="min-width: 150px">
                            <template #body="{ data }">
                                <span class="font-mono font-semibold">{{ data.container_number }}</span>
                            </template>
                            <template #header>
                                <div class="text-left w-full">Container No</div>
                            </template>
                        </Column>
                        ...
                        <Column field="destuff_date" sortable style="min-width: 120px">
                            ...
                            <template #header>
                                <div class="text-left w-full">Destuff</div>
                            </template>
                        </Column>

                        <Column field="agent_name" style="min-width: 150px">
                            <template #body="{ data }">
                                <span>{{ data.agent_name }}</span>
                            </template>
                            <template #header>
                                <div class="text-left w-full">Agent</div>
                            </template>
                        </Column>

                        <Column field="no_of_cons" style="min-width: 100px">
                            <template #body="{ data }">
                                <span class="text-right block">{{ data.no_of_cons }}</span>
                            </template>
                            <template #header>
                                <div class="text-right w-full">No of Cons</div>
                            </template>
                        </Column>
                        ...
                        <Column field="no_of_pkgs" style="min-width: 100px">
                            ...
                            <template #header>
                                <div class="text-right w-full">No of Pkgs</div>
                            </template>
                        </Column>

                        <Column field="cbm" style="min-width: 100px">
                            <template #body="{ data }">
                                <span class="font-mono text-right block">{{ formatCBM(data.cbm) }}</span>
                            </template>
                            <template #header>
                                <div class="text-right w-full">CBM</div>
                            </template>
                        </Column>
                        ...
                        <Column field="slpa" style="min-width: 120px">
                            ...
                            <template #header>
                                <div class="text-right w-full">SLPA</div>
                            </template>
                        </Column>
                        ...
                        <Column field="handling" style="min-width: 120px">
                            ...
                            <template #header>
                                <div class="text-right w-full">Handling</div>
                            </template>
                        </Column>
                        ...
                        <Column field="bond" style="min-width: 120px">
                            ...
                            <template #header>
                                <div class="text-right w-full">Bond</div>
                            </template>
                        </Column>

                        <Column field="demurr" style="min-width: 120px">
                            <template #body="{ data }">
                                <span class="font-mono text-right block">{{ formatNumber(data.demurr) }}</span>
                            </template>
                            <template #header>
                                <div class="text-right w-full">Demurr</div>
                            </template>
                        </Column>

                        <Column field="frt_chg" style="min-width: 120px">
                            <template #body="{ data }">
                                <span class="font-mono text-right block">{{ formatNumber(data.frt_chg) }}</span>
                            </template>
                            <template #header>
                                <div class="text-right w-full">Frt Chg</div>
                            </template>
                        </Column>

                        <Column field="doc_chg" style="min-width: 120px">
                            <template #body="{ data }">
                                <span class="font-mono text-right block">{{ formatNumber(data.doc_chg) }}</span>
                            </template>
                            <template #header>
                                <div class="text-right w-full">DOC Chg</div>
                            </template>
                        </Column>
                        ...
                        <Column field="vat" style="min-width: 120px">
                            ...
                            <template #header>
                                <div class="text-right w-full">VAT</div>
                            </template>
                        </Column>

                        <Column field="nbt_paid" style="min-width: 120px">
                            <template #body="{ data }">
                                <span class="font-mono text-right block">{{ formatNumber(data.nbt_paid) }}</span>
                            </template>
                            <template #header>
                                <div class="text-right w-full">NBT Paid</div>
                            </template>
                        </Column>
                        ...
                        <template #footer>
                            <div class="flex justify-between items-center">
                                <span>In total there are {{ totalRecords }} container records.</span>
