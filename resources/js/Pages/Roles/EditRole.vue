...
const groupPermissions = ref({}); // Store permissions for each group
const selectedPermissions = ref({}); // Store selected permissions for each group
const loadedGroups = ref(new Set()); // Track which groups have loaded
...
// Handle the "All Permissions" checkbox
