...
stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-door"><path stroke="none" d="M0 0h24v24H0z" fill="none"/>
              ...
              <!-- <div class="flex justify-end">
                ...
                >
                  <svg
                    v-if="isImportant"
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5.5 text-success dark:text-accent"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
              ...
              <!-- <div class="flex justify-end">
                ...
                >
                  <svg
                    v-if="isUrgentPickup"
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5.5 text-secondary dark:text-accent"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
