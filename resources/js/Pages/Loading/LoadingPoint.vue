                ...
                <div
                    ...
                    <div class="board-draggable relative flex max-h-full shrink-0 flex-col">
                        ...
                        <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5">
                            <div v-for="(packageData, index) in hblPackagesArr" :key="packageData.id"
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="px-2.5">
                                        <svg class="icon icon-tabler icons-tabler-outline icon-tabler-corner-up-right-double hover:text-success" fill="none"  height="24"  stroke="currentColor"  stroke-linecap="round"  stroke-linejoin="round"  stroke-width="2"  viewBox="0 0 24 24"  width="24"  x-tooltip.placement.top.success="'Click to Load'"  xmlns="http://www.w3.org/2000/svg"  @click.prevent="handleLoad(index)"><path d="M0 0h24v24H0z" fill="none" stroke="none"/><path d="M4 18v-6a3 3 0 0 1 3 -3h7" /><path d="M10 13l4 -4l-4 -4m5 8l4 -4l-4 -4" /></svg>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="board-draggable relative flex max-h-full shrink-0 flex-col">
                        ...
                        <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5">
                            <div v-for="(packageData, index) in containerArr" v-if="containerArr.length > 0" :key="packageData.id"
                                 class="card cursor-pointer shadow-sm">
                                <div class="flex justify-between items-center">
                                    <div class="space-y-3 rounded-lg px-2.5 pb-2 pt-1.5">
                                        <div>
                                    ...
                                    <div class="px-2.5">
                                        <svg class=" hover:text-error icon icon-tabler icons-tabler-outline icon-tabler-corner-up-left-double" fill="none" height="24"  stroke="currentColor"  stroke-linecap="round"  stroke-linejoin="round"  stroke-width="2"  viewBox="0 0 24 24"  width="24"  x-tooltip.placement.top.error="'Click to Unload'"  xmlns="http://www.w3.org/2000/svg"  @click.prevent="handleUnload(index)"><path d="M0 0h24v24H0z" fill="none" stroke="none"/><path d="M19 18v-6a3 3 0 0 0 -3 -3h-7" /><path d="M13 13l-4 -4l4 -4m-5 8l-4 -4l4 -4" /></svg>
                                    </div>
                                </div>
                            </div>
