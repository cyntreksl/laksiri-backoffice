                ...
                <div class="sm:col-span-2">
                    <div class="card px-4 py-4 sm:px-5">
                        <div class="flex justify-between items-center">
                            ...
                            <a x-tooltip.placement.bottom="'Copy from HBL'"
                               @click.prevent="confirmShowingCopyFromHBLToShipperModal">
                                <svg class="icon icon-paste text-[#64748b]" fill="none" height="24"
                                     stroke="#64748b"
                        ...
                        <div class="grid grid-cols-3 gap-5 mt-3">
                            <div class="col-span-3">
                                ...
                                <InputError :message="form.errors.contact_number" class="col-span-3"/>
                            </div>
                        </div>
                        ...
                        <div v-if="!isSameContactNumber" class="grid grid-cols-3 gap-5 mt-3">
                            <div class="col-span-3">
                                ...
                                <InputError :message="form.errors.whatsapp_number" class="col-span-3"/>
                            </div>
                        </div>
                    ...
                    <div class="card px-4 sm:px-5 p-4">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-1">
                                <a  v-if="form.hbl_name"  class="relative inline-flex items-center"
                                ...
                                >
                                    <svg class="icon icon-paste text-[#64748b] ml-1" fill="none" height="24"
                                         stroke="#64748b"
                                         stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <!-- Clipboard shape -->
                        ...
                        <div class="grid grid-cols-2 gap-5 mt-3">
                            ...
                            <div class="col-span-2">
                                ...
                                <InputError :message="form.errors.consignee_contact" class="col-span-3"/>
                            </div>
                    ...
                    <div class="card p-1" style="height: 100%">
                        <div class="mt-4 flex justify-between items-center">
                            <div class="flex items-center space-x-2">
                                ...
                                >
                                    <svg class="icon icon-paste text-[#64748b] ml-5" fill="none" height="24"
                                         stroke="#64748b"
                                         stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <!-- Clipboard shape -->
                            ...
                            <PrimaryOutlineButton v-if="Object.values(copiedPackages).length === 0" :disabled="!isExistsRules" type="button"
                        ...
                        <div class="mt-5">
                            ...
                            <div v-if="packageList.length === 0 && Object.values(copiedPackages).length === 0"
                                ...
                                <PrimaryOutlineButton :disabled="!isExistsRules" type="button" @click="showPackageDialog">
                                    New Package <i class="fas fa-plus fa-fw fa-fw"></i>
                                </PrimaryOutlineButton>
                            </div>
                        </div>
