      ...
      return h("div", { className: "flex space-x-2" }, [
        h(
          "button",
          {
            ...
            "x-tooltip..placement.bottom.primary": "'Edit HBL'",
          },
          [
            h(
              "svg",
        ...
        h(
          "button",
          {
            ...
            "x-tooltip..placement.bottom.primary": row.cells[14].data
              ? "'Release HBL'"
              : "'Hold HBL'",
          },
          [
            ...
            >
              ...
              <div class="flex">
                <div>
                  ...
                  <div
                    class="mb-1 badge bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"
                  >
                    {{ filters.fromDate }}
                  </div>
                </div>
