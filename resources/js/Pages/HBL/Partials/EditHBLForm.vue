...
<template>
    ...
    <form @submit.prevent="handleHBLUpdate">
        ...
        <div class="card col-span-5 px-4 py-4 sm:px-5 mb-10">
            ...
            <div class="mt-5">
                <div v-if="form.packages.length > 0" class="is-scrollbar-hidden min-w-full overflow-x-auto">
                    <table class="is-zebra w-full text-left">
                        ...
                        <tr v-for="(item, index) in form.packages">
                            ...
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ item.package_type }}</td>
                        ...
                        <div class="col-span-2">
                            <label class="block">
                                ...
                                <select
                                    ...
                                    <option v-for="package_type in packageTypes" :key="package_type">{{ package_type }}</option>
                                </select>
                            </label>
                        </div>
                        <div class="col-span-2">
