            ...
            <div>
                <div class="flex items-center justify-between p-2">
                        ...
                        <div class="flex items-center mt-2 text-sm text-slate-500 dark:text-gray-300">
                            ...
                            <div class="flex -space-x-px">
                                ...
                                <div>
                                    ...
                                    <div v-for="(type, index) in filters.deliveryType" v-if="filters.deliveryType"
                    ...
                    <div class="flex space-x-2">
                        ...
                        <button class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.top="'Filter result'"
