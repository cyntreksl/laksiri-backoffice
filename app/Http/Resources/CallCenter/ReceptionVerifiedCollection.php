...
class ReceptionVerifiedCollection extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_checked' => $this->reception_verification->is_checked,
            'verified_by' => $this->reception_verification->verifiedBy->name,
            'note' => $this->reception_verification->note,
            'verified_at' => $this->reception_verification->created_at->format('Y-m-d H:i:s'),
