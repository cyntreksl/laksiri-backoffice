...
class DownloadHBLReportPDF
{
    use AsAction;

    public function handle(Collection $hbls, Request $request, bool $detailed = false)
    {
        ...
        // Generate PDF using BrowsershotLambda with optimized settings
