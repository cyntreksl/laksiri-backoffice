...
Route::name('loading.')->group(function () {
    ...
    Route::get('/loaded-containers/{container}/manifest/excel/export', [LoadedContainerController::class, 'exportManifestExcel'])
        ->name('loaded-containers.manifest.excel.export');
